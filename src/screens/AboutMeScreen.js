  ...
  return (
    <div className="screen">
      <div className="about">
        <div className="row">
          <div style={{ display: "flex", width: "100%", alignItems: "center" }}>
            ...
            <div className="col-8 vertical-center-col about__col ">
              <div className="about__text">
                ...
                <p className="about__text--description">
                  * Lorem ipsum dolor sit amet consectetur adipisicing elit.{" "}
                  ...
                  <br /> * exercitationem veritatis itaque quisquam quis
                  similique <br />*<br /> * voluptatem voluptas eligendi.
                  Delectus vel rerum <br />* placeat molestias, aperiam eaque
                  provident,
                  <br /> * qui itaque illum illo alias autem libero atque
                  fugiat!
                </p>
      ...
      <div className="sideNav">
        <h3 className="sideNav__heading">_explorer</h3>
